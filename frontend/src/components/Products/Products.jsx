            ...
            {loading ? (
              ...
              <div className="flex flex-wrap gap-6 mt-10">
                {products.map((product) => (
                  <div
                    key={product.id}
                    className="flex flex-col w-[30%] bg-white shadow-md border-t border-gray-100 overflow-hidden relative group"
                  >
                    {/* Image section */}
                    <div className="relative flex-1 flex flex-col">
                      ...
                      <div className="absolute bottom-0 w-full bg-purple-200 bg-opacity-90 px-3 py-2 flex justify-between items-center">
                        ...
                        <p className="text-lg font-bold text-purple-700 mt-1">₹{product.price}</p>
                      </div>
                    ...
                    <div className="px-4 py-2 flex justify-between items-center border-t border-purple-300 bg-purple-200">
